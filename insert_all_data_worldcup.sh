...
# Script to insert data from games.csv to world cup database
echo $($PSQL "TRUNCATE TABLE games,teams")
cat games_test.csv | while IFS="," read YEAR ROUND WINNER OPPONENT WINNERGOALS OPPONENTGOALS
 do
  if [[ $YEAR != year ]]
  then
